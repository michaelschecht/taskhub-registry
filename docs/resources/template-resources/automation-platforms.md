...
<h1 align="center">🔗 Automation Platform Galleries</h1>

<p align="center">
  <em>Workflow-template catalogs — mine the <strong>ideas</strong> and re-express them as scheduled commands.</em>
</p>
...
These are mostly SaaS/flow galleries, not scripts — adapt the *idea* (trigger + steps) into a scheduled command.
